...
test_acc_results = []
test_loss_results = []
l2= [Adam(lr=0.0001,amsgrad = False), AAdam(lr=0.0001,amsgrad = False),Adam(lr=0.0001,amsgrad = True), AAdam(lr=0.0001,amsgrad = True)]
for opt in l2:

    model.compile(loss='categorical_crossentropy',
              optimizer=opt,
              metrics=['accuracy'])
    #model.save_weights('initial_weights2.h5')
